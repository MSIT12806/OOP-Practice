...
namespace TestProject
{
    public class EmpServiceTests
    {
        ...
        public async Task AcceptanceMounthlyPaymentTest()
        {
            ...
            // empService
            MounthlyEmployee? employee;
            await using (var empService = _serviceProvider.GetRequiredService<EmpService>())
            {

                // 添加員工
                employee = empService.Build("AA", "Jane Doe", "123 Main St", Emp.PayWayEnum.Monthly) as MounthlyEmployee;
            }
